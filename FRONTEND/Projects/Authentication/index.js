...
function showView(view) {
    document.getElementById("signup").style.dispaly =
    view === "signup" ? "block" : "none";
    document.getElementById("login").style.dispaly =
    view === "login" ? "block" : "none";
    document.getElementById("dashboard").style.dispaly =
...
function login() {
    ...
    const storedUsers = JSON.parse(localStorage.grtItem("users")) || [];
